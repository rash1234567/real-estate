    ...
    <div className='bg-[#101010] p-4 md:p-8 lg:p-16 mt-16 flex flex-col justify-around'>
         <div className='flex flex-col md:flex-row md:justify-between'>
            <div>
                ...
                <h1 className='mt-4 text-2xl md:text-3xl lg:text-4xl text-white capitalize'><span className='text-[#00FFA3] text-sm md:text-lg mr-1 items-center'>2020 lobro</span>Take the keys.</h1>
            </div>
            <div className='flex flex-col w-full md:w-1/2 justify-around'>
                <div className='flex justify-between w-full items-center email'>
                    ...
                    <button className='bg-[#00FFA3] text-black mt-2 md:mt-0 px-2 md:py-4 md:px-7 font-semibold'>Get Started</button>
                </div>
